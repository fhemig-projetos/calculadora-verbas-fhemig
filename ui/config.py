CONFIG_CAMPOS = {
    ...
    "carga_horaria_mensal": {
        "label": "Carga Horária Mensal (h/mês)",
        "tipo": "hora_mensal",
    },
    ...
    "valor_outras_vantagens": {
        "label": "Outras Vantagens (soma automática do histórico) (R$)",
        "tipo": "moeda",
    },
