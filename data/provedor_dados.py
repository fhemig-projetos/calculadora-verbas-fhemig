...
class ProvedorDadosFhemig:
    ...
    def _carregar_dados_globais() -> dict:
        """Carrega o ficheiro JSON de tabelas uma única vez e mantém em cache.
