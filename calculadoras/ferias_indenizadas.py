...
class CalculadoraFeriasIndenizadas(CalculadoraVerba):
    ...
    def campos_necessarios(self) -> list[str]:
        return ["vencimento_basico", "abono_emergencia", "valor_grs", "adicional_noturno", "dias_ferias_indenizadas"]

    def calcular(self, vencimento_basico: float, abono_emergencia: float, valor_grs: float, adicional_noturno: float, dias_ferias_indenizadas: int) -> ResultadoCalculo:
